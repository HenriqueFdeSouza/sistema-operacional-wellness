...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Wellness Control Hub" },
      { name: "description", content: "Sistema de gestão operacional para resort de luxo." },
      { name: "author", content: "Wellness" },
      { property: "og:title", content: "Wellness Control Hub" },
